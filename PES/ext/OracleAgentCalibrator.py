...
This code contains a NN-Agent that given a FIXED set of allocations, and a set of other different allocations and reported confidences (given by somebody else) it provides
the OPTIMAL reported confidence that MAXIMIZES the performance of a group of two players working together on the Pandemic Scenario (with weighting average).
