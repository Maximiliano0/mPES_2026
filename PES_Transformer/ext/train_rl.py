'''
PES_Transformer — Q-Learning baseline training script (from PES_QLv2).

This module is preserved as a Q-Learning baseline for comparison with the
Transformer agent.  For the Transformer training pipeline, see
...
Usage::
    ...
    python3 -m PES_Transformer.ext.train_rl
'''
