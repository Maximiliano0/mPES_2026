...
def provide_ac_agent_response(
    ...
    Notes
    -----
    - Requires A2C pre-training via: ``python3 -m pes_ac.ext.train_ac``
    ...
    if not os.path.exists(model_path):
        raise FileNotFoundError(
            ...
            f"Please train the A2C Agent first by running: python3 -m pes_ac.ext.train_ac\n"
        )
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"Error: {str(e)}\n"
            f"File may be corrupted. Please retrain by running: python3 -m pes_ac.ext.train_ac\n"
        ) from e
