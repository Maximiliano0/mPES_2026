"""
Package initialization module for pes_actor_critic (Pandemic Experiment Scenario
with Advantage Actor-Critic).

Variant of pes that replaces tabular Q-Learning with an Advantage Actor-Critic
