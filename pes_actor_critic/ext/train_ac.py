'''
pes_actor_critic - Pandemic Experiment Scenario: A2C Training Pipeline
...
::
    ...
    python3 -m pes_actor_critic.ext.train_ac [num_episodes]
'''
...
def main():
    ...
    train_dir = os.path.join(INPUTS_PATH, f'{train_date}_AC_TRAIN')
    ...
    info(f"  Critic hidden units: {AC_CRITIC_HIDDEN_UNITS}")
    ...
    rewards, actor_model, confsrl = A2CTraining(
        env, actor_lr, critic_lr,
        discount_factor, entropy_coeff,
        epsilon_initial, epsilon_min, num_episodes,
        actor_hidden=AC_ACTOR_HIDDEN_UNITS,
        critic_hidden=AC_CRITIC_HIDDEN_UNITS,
        seed=SEED,
    ...
    with open(config_file, 'w', encoding='utf-8') as f:
        ...
        f.write(f"Actor Hidden Units:          {AC_ACTOR_HIDDEN_UNITS}\n")
        f.write(f"Critic Hidden Units:         {AC_CRITIC_HIDDEN_UNITS}\n\n")
