"""
Main entry point for the pes_base_line experiment.
...
def main():
    """Orchestrate the full pes_base_line experiment lifecycle."""
    ...
    if PLAYER_TYPE == 'RL_AGENT':
        ...
        if not os.path.isfile(q_file):
            ...
            terminal_utils.list_item("python3 -m pes_base_line.ext.train_rl")
            print()
            return
