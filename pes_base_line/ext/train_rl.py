'''
pes_base_line - Pandemic Experiment Scenario: RL-Agent Training Pipeline
...
Key differences from pes/ext/train_rl.py
----------------------------------------
- Uses Bayesian-optimised hyperparameters (lr ≈ 0.360, γ ≈ 0.865, ε₀ ≈ 0.679,
  ε_min ≈ 0.085) instead of pes defaults
- Default episodes: 900 000 (pes uses 20 000)
...
::
    ...
    python3 -m pes_base_line.ext.train_rl [num_episodes]
'''
...
def main():
    ...
    rewards, Q, confsrl = QLearning(env, learning_rate, discount_factor,
                                    epsilon_initial, epsilon_min, num_episodes, seed=SEED)
    print()
    ...
    if True:  # pylint: disable=using-constant-test
        ...
        def eval_qf(_env, state, _seqid):
            """Select the best action using the trained Q-table with meta-cognitive confidence."""
