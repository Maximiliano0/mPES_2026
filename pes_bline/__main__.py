"""
Main entry point for the pes_bline experiment.
...
def main():
    """Orchestrate the full pes_bline experiment lifecycle."""
    ...
    if PLAYER_TYPE == 'RL_AGENT':
        ...
        if not os.path.isfile(q_file):
            ...
            terminal_utils.list_item("python3 -m pes_bline.ext.train_rl")
            print()
            return
