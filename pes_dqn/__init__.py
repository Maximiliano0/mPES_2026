...
Variant of pes_base that replaces tabular Q-Learning with a neural-network-based
...
- Package exports via __all__ (43 symbols)
"""
######################
## External Imports ##
######################
...
DQN_HIDDEN_UNITS = CONFIG.DQN_HIDDEN_UNITS
DQN_BATCH_SIZE = CONFIG.DQN_BATCH_SIZE
DQN_REPLAY_BUFFER_SIZE = CONFIG.DQN_REPLAY_BUFFER_SIZE
DQN_TARGET_SYNC_FREQ = CONFIG.DQN_TARGET_SYNC_FREQ
DQN_LEARNING_RATE = CONFIG.DQN_LEARNING_RATE
DQN_TRAIN_FREQ = CONFIG.DQN_TRAIN_FREQ
DQN_MODEL_FILE = CONFIG.DQN_MODEL_FILE
