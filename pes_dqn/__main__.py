...
validation of the DQN model file, session creation with logging,
...
def main():
    ...
    if PLAYER_TYPE in ('RL_AGENT', 'DQN_AGENT'):
        ...
        terminal_utils.info("Checking DQN model files...")
        ...
        for CurrentBlockIndex in range(NUM_BLOCKS):
            ...
            for CurrentSequenceIndex, CurrentSequenceMapIndex in enumerate(CurrentBlockMapIndices):
                ...
                for trial_no in range(
                    ...
                    else:   # i.e. resources_left <= 0 or not DQN Agent
                ...
                # For DQN Agent, print results to console
            ...
            # Update TrustRatings (skip for DQN Agent)
