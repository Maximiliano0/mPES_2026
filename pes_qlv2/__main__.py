...
assert __package__ and len( __package__ ) > 0, """
...
from . import (
    ...
    INPUTS_PATH, MAX_ALLOCATABLE_RESOURCES, MAX_INIT_RESOURCES, MAX_INIT_SEVERITY, MIN_ALLOCATABLE_RESOURCES,
    MIN_INIT_RESOURCES, MIN_INIT_SEVERITY, NUM_ATTEMPTS_TO_ASSIGN_SEQ, NUM_BLOCKS, NUM_MAX_TRIALS, NUM_MIN_TRIALS,
    NUM_SEQUENCES, OUTPUT_FILE_PREFIX, OUTPUTS_PATH, PLAYER_TYPE, RANDOM_INITIAL_SEVERITY,
    SAVE_INITIAL_SEVERITY_TO_FILE, SAVE_RESULTS, STARTING_BLOCK_INDEX, STARTING_SEQ_INDEX,
...
###################################
def main():
    """Run the full pes_qlv2 experiment: validate, execute blocks/sequences, and save results."""
