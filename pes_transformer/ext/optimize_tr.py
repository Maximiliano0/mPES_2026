'''
PES_Transformer — Q-Learning Bayesian Optimisation (from PES_QLv2).

Note: This module optimises Q-Learning hyperparameters and is not directly
applicable to the Transformer agent.  Kept for baseline comparison.
