'''
pes_trf — Training script for the Transformer-based RL agent.
...
``pes_dql/ext/train_rl.py`` but replaces tabular Q-Learning with
...
Usage::
    ...
    python3 -m pes_trf.ext.train_transformer [n_batches]
...
def main():
    ...
    header("pes_trf — Transformer Training", width=80)
